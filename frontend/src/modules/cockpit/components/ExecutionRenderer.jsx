...
const ExecutionRenderer = ({ execution, showOverlay = true, chartState = 'ready' }) => {
  ...
  // ========================================
  // STATE 2: NO EXECUTION DATA - Small badge only
  // FIX: Removed blocking overlay - chart renders independently
  // Execution is OPTIONAL overlay, not blocking element
  // ========================================
  if (!execution) {
    return (
      <ExecutionBadge $status="no_trade" data-testid="execution-badge">
        {getStatusIcon('no_trade')} ANALYZING
      </ExecutionBadge>
    );
  }
